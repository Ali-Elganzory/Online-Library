...
<script type="application/javascript" src="views/mainpage/mainpage.js"></script>
...
<div class="boxes">
    ...
    <svg onclick="fav('<?= $book->id ?>')" class="heart" xmlns="http://www.w3.org/2000/svg"
         xmlns:xlink="http://www.w3.org/1999/xlink" width="37.255" height="35.9" viewBox="0 0 37.255 35.9">
        <defs>
            <style>.a {
                    clip-path: url(#a);
                }
            ...
            <clipPath id="a">
                <path d="M0-47.5H37.255v35.9H0Z" transform="translate(0 47.5)"/>
            </clipPath>
        </defs>
        <g transform="translate(0 47.5)">
            <g transform="translate(0 -47.5)">
                <g class="a">
                    <g transform="translate(3.007 3.907)">
                        <path class="b" id="<?= $book->id ?>"
                              d="M0-2.5c0-8.313,11.945-11.393,15.621-1.77C19.3-13.892,31.242-10.811,31.242-2.5c0,9.032-15.621,20.483-15.621,20.483S0,6.533,0-2.5"
